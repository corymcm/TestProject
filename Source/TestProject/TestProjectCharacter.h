...
protected:
	...
	/** Called for when the users pressed the button to change Cameras */
	void ChangeCamera();
...
public:
	...
	/** Returns FPVCamera subobject **/
	FORCEINLINE class UCameraComponent* GetFPVCamera() const { return FPVCamera; }
